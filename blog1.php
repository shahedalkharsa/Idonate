	...
	<div class="container" style="padding-top:0px;">
			...
			<div class="row mt30">	
				...
				<div class="team-wrapper">
							...
							<div id="flip"> <h3> 3 Positive Effects of Donating Money to Charity </h3> <br>
          By Jay Robertson in July 13, 2015<br>
         <img src="images/ps.jpg" alt="" style="width:100%;"></div>
		<div id="panel"> 
          ...
          echo  $result->fetch_assoc()['article']    ;?>
				...
				<div class="team-wrapper">
					...
					<div id="flip1"> <h3> What do orphans need?  <h3> <br><br>
					<img src="images/Syrian.jpg" alt="" style="width:100%;">

					</div>
					
							<div id="panel1"> 
							
							  <?php $result->data_seek(1);
                              echo  $result->fetch_assoc()['article']    ;?>
						   </div>

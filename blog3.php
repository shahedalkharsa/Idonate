	...
	<div class="container" style="padding-top:0px;">
			...
			<div class="row mt30">	
				...
				<div class="team-wrapper">
							...
							<div id="flip5"> <h3> The Importance of Volunteering and Donating to Your Local Shelter</h3> <br>
				  by Mary Beth McAndrews, February 5, 2017 <br> <img src="images/dog.jpg" alt="" style="width:100%;">

								</div>
					<div id="panel5"> 
					
							  <?php $result->data_seek(4);
